...
2. 周期差异（必须遵守）：
   - timeframe=30（30分钟 · 日内 T0）：默认有底仓但**底仓不动**。卖出只针对「今日已买入、尚未平仓」的日内仓；若尚无日内买入却给出 sell，系统会忽略。有未平日内仓时禁止再 buy，必须先 sell。当天买入必须当天卖出（尾盘未卖则强制平仓）。
     · 有日内仓：浮盈约 0.6%–1.0%、量能转弱/滞涨或跌破成本附近，应优先 sell，勿拖到尾盘强平。
     · 无日内仓：volume_hint 为缩量（shrink）或价涨量缩诱多（bull_trap）时禁止凑 buy。
...
- 系统会对 shrink / bull_trap / 低置信度 buy 做硬过滤；你仍应主动避免给出这类 buy。
...
反例 F：有日内仓且已明显浮盈/量能转弱，仍 hold 拖到尾盘强平 → 错误。
反例 G：缩量或价涨量缩仍给出 buy → 错误。
